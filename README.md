## Привет！👋
Меня зовут Марк, я Fullstack QA Engineer 
...
Универсальный QA инженер с опытом разработки микросервисов на Go (чистая архитектура, REST/gRPC API) и написания автотестов всех уровней: API-тесты на Python (pytest + requests), UI-тесты на Cypress (JavaScript). Автоматизирую рутину: создал Telegram-бота для генерации тестовых файлов. Работаю с PostgreSQL, Docker, CI/CD. Тестирую backend, frontend и интеграции — закрываю полный цикл качества.

Открыт к предложениям на позицию Fullstack QA Engineer. Если у вас есть вакансия, которая соответствует моим навыкам, не стесняйтесь связаться со мной 🙌
